 ...
 * GL surface view
 */
public class CCardGLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
    private static final String TAG = CCardGLSurfaceView.class.getCanonicalName();
    ...
    public CCardGLSurfaceView(android.content.Context context) {
        super(context);
        initGL();
    }

    public CCardGLSurfaceView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        initGL();
    }
    ...
    public void onDrawFrame(GL10 glUnused) {
        ...
        final CCardUtils.CCardTransformationInfo tInfo = new CCardUtils.CCardTransformationInfo(swapSize ? imageHeight : imageWidth, swapSize ? imageWidth : imageHeight, getWidth(), getHeight());
