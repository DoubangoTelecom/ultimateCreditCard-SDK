...
import org.doubango.ultimateCreditCard.R; // FIXME(dmi): must remove


public class CCardCameraFragment extends Fragment
    ...
    static final String TAG = CCardCameraFragment.class.getCanonicalName();
    ...
    /**
     * An {@link CCardGLSurfaceView} for camera preview.
     */
    private CCardGLSurfaceView mGLSurfaceView;

    private CCardView mCardView;
    ...
    private final CCardBackgroundTask mBackgroundTaskCamera = new CCardBackgroundTask();
    private final CCardBackgroundTask mBackgroundTaskDrawing = new CCardBackgroundTask();
     ...
     */
    public CCardCameraFragment() {
        // nothing special here
    }

    private CCardCameraFragment(final Size preferredSize, final CCardCameraFragmentSink sink) {
     ...
     * @return
     */
    public static CCardCameraFragment newInstance(final Size preferredSize, final CCardCameraFragmentSink sink) {
        return new CCardCameraFragment(preferredSize, sink);
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mGLSurfaceView = (CCardGLSurfaceView) view.findViewById(R.id.glSurfaceView);
        mCardView = (CCardView) view.findViewById(R.id.cardView);
    ...
    public synchronized void onResume() {
        ...
        if (mSink != null && mCardView != null) {
            mSink.setCCardView(mCardView);
        }
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    ...
                    mCardView.setAspectRatio(mPreviewSize.getWidth(), mPreviewSize.getHeight());
                } else {
                    mGLSurfaceView.setAspectRatio(mPreviewSize.getHeight(), mPreviewSize.getWidth());
                    mCardView.setAspectRatio(mPreviewSize.getHeight(), mPreviewSize.getWidth());
                }
    ...
    /**
     * Opens the camera specified by {@link CCardCameraFragment#mCameraId}.
     */
