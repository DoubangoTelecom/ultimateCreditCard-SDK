 ...
 * License activator.
 */
public class CCardLicenseActivator {

    /**
     * TAG used for the debug logs.
     */
    static final String TAG = CCardLicenseActivator.class.toString();
     ...
     */
    static final String LICENSE_TOKEN_FILE_NAME = "ultimateCreditCard-token.lic";
            ...
            return Executors.newSingleThreadExecutor().submit(new Callable<String>() {
                ...
                public String call() throws Exception {
                    ...
                    try {
                        ...
                        final UltCreditCardSdkResult result = UltCreditCardSdkEngine.requestRuntimeLicenseKey(true);
                        if (!result.isOK()) {
